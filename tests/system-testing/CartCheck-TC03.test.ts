...
test.describe('Shopping Cart Flow', () => {
    ...
    test('CartCheck-TC03: Login and add multiple items to cart', async ({ page, tcData }) => {
        ...
        // tests with 1 products without needing separate test cases.
